...
function Designpage() {
  return (
    <>
      <Container>
        <Row className='px-md-0 mt-4 px-3'>
          <Col md={5} sm={12} className='align-items-center text-center pt-3 ps-4'>
          ...
          <Col md={7} sm={12} className='mt-4' >
            <div className='align-items-center text-center'>
              ...
              <div >
                ...
                <Row className='g-3 text-md-start text-center ms-auto mt-md-3 d-flex justify-content-around mt-1'>
